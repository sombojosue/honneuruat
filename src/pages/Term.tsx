          ...
          <div className="container my-5">
            <div className="card shadow-sm rounded-4">
              <div className="card-body p-4">
                ...
                <p>
                  <strong>b. Propriété intellectuelle :</strong> Aucune revente
                  ou modification sans autorisation.
                </p>
                <p>
                  <strong>c. Livraison :</strong> Designs numériques par e-mail,
                  physiques avec suivi.
                </p>
                <p>
                ...
                <p>
                  <strong>d. Responsabilité :</strong> Le client doit respecter
                  les conditions du lieu réservé.
                </p>
                ...
                <p>
                  <strong>b. Paiements :</strong> 50 % à la réservation, solde 5
