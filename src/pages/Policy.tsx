                    ...
                    <div className="col-lg-12 align-self-center mb-lg-0 mb-4">
                      <section className="mb-5">
                        ...
                        <p>
                          ...
                          une expérience sûre, équitable et transparente pour
                      ...
                      <section className="mb-5">
                        ...
                        <p>
                          ...
                          licenciées. Il est interdit de revendre, redistribuer
                          ou modifier les designs sans autorisation écrite.
                        </p>

                        <p>c. Livraison</p>
                        <p>
                          Les designs numériques sont livrés par e-mail ou via
                          un lien de téléchargement. Les designs physiques
                          seront expédiés avec suivi.
                        </p>
                        ...
                        <p>
                          ...
                          peuvent être retournés sous 7 jours en cas de défaut
                      ...
                      <section className="mb-5">
                        ...
                        <p>
                          ...
                          restaurants ou des hôtels pour des événements
                          personnels ou professionnels. La disponibilité peut
                          varier jusqu’à confirmation officielle.
                        </p>
                      ...
                      <section className="mb-5">
                        ...
                        <p>
                          Comprend : consultation, coordination des
                          prestataires, décoration du lieu, gestion du personnel
                          et supervision le jour de l’événement.
                        </p>
                        ...
                        <ul>
                          ...
                          <li>
                            <p>
                              <strong>Entre 7 et 14 jours</strong> :
                              remboursement de 50 %
                            </p>
                          </li>
                          <li>
